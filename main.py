...
from aiohttp import web  # ✅ faqat health endpoint uchun
...
# ✅ UptimeRobot ping qilishi uchun (sleep bo'lmasin)
...
def main():
    ...
    # webhook (Render) — sizdagi kabi, faqat health app qo'shildi ✅
    app.run_webhook(
        listen="0.0.0.0",
        port=PORT,
        url_path="webhook",
        webhook_url=f"{WEBHOOK_BASE}/webhook",
        web_app=health_app,  # ✅ ping uchun endpointlar
    )
